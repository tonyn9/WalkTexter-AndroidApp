 ...
 */
public class WTNotifications {
    /**
     * The unique identifier for this type of notification.
     */
    private static final String NOTIFICATION_TAG = "WTs";
     ...
     * presentation of wts notifications. Make
     * sure to follow the
    ...
    public static void notify(final Context context,
        ...
        final NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                ...
                .setStyle(new NotificationCompat.BigTextStyle()
                        ...
                        .setSummaryText("Don't worry. Slow down, nice and slow. We want you to be safe." +
                                "So please, take a few seconds to look up :)"))
